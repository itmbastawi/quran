...
def juzfv():
    ...
    juzform=SQLFORM(db.quranj,request.args(0),fields=['readj'],showid=False,buttons = [TAG.button('تأكيد القراءة',_type="submit")],labels ={'readj':'اضغط هنا'},formstyle = 'divs').process()
